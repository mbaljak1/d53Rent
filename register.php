<?php 
	...
	if (($_POST['_action_']) == FALSE) {
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<label for="password">Zaporka:* <small>(Zaporka mora imati min. 4 znaka)</small></label>
			<input type="password" id="password" name="password" placeholder="Zaporka.." pattern=".{4,}" required>
